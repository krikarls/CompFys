...
{
    int N;
    double a, b, fx,r1,r2,costheta1,costheta2,phi1,phi2, exact,lambda, int_bMC, int_MC;
...
//  computation loop: Monte carlo using importance sampling
    ...
    std::cout << "Brute force Monte carlo: " << int_bMC << std::endl;
    std::cout << "Monte carlo(imprtance sampling): " << int_MC << std::endl;
}
