...
//    final output
      ...
      cout << "Gaussian-Legendre quad = "<< setw(20) << setprecision(15)  << int_gauss_leg << "   Rel.error:  " << fabs(int_gauss_leg-exact)/exact << endl;
      cout << "Gaussian-Laguerre quad = " << setw(20) << setprecision(15) << int_gauss_lag  << "   Rel.error:  " << fabs(int_gauss_lag-exact)/exact << endl;
}  // end of main program
